...
INSERT INTO style_element_options (sub_dim, value, label, mount_anchor, layout_mode, css_template, sort_order, is_enabled) VALUES
  ('header_deco', 'diagonal',  'Diagonal 斜纹',     'top',  'placeholder', '.gallery-card[data-style-element-header="diagonal"] .card-header-band { background: repeating-linear-gradient(45deg, var(--card-accent, #ccc) 0 6px, transparent 6px 12px); }', 5, true),
  ('header_deco', 'breathing', 'Breathing 呼吸',   'top',  'placeholder', '.gallery-card[data-style-element-header="breathing"] .card-header-band { background: var(--card-accent, #ccc); animation: band-breathing 2.4s ease-in-out infinite; }', 6, true),
  ('header_deco', 'scanline',  'Scanline 扫描',    'top',  'placeholder', '.gallery-card[data-style-element-header="scanline"] .card-header-band { background: linear-gradient(to bottom, transparent, var(--card-accent, #ccc), transparent); background-size: 100% 200%; animation: band-scanline 1.6s linear infinite; }', 7, true);
...
INSERT INTO style_element_options (sub_dim, value, label, mount_anchor, layout_mode, css_template, sort_order, is_enabled) VALUES
  ('side_accent', 'diagonal',  'Diagonal 斜纹',     'left', 'placeholder', '.gallery-card[data-style-element-side="diagonal"] .card-side-band { background: repeating-linear-gradient(45deg, var(--card-accent, #ccc) 0 6px, transparent 6px 12px); }', 6, true),
  ('side_accent', 'breathing', 'Breathing 呼吸',   'left', 'placeholder', '.gallery-card[data-style-element-side="breathing"] .card-side-band { background: var(--card-accent, #ccc); animation: band-breathing 2.4s ease-in-out infinite; }', 7, true),
  ('side_accent', 'scanline',  'Scanline 扫描',    'left', 'placeholder', '.gallery-card[data-style-element-side="scanline"] .card-side-band { background: linear-gradient(to right, transparent, var(--card-accent, #ccc), transparent); background-size: 200% 100%; animation: band-scanline 1.6s linear infinite; }', 8, true);
